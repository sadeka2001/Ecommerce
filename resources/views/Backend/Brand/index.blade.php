...
@section('admin_content')
    ...
    <div class="row-fluid sortable">
        <div class="box span12">
                            ...
                            <tr>
                                ...
                                <td class="row">
                                    ...
                                    <div class="span2">
                                        ...
                                        @if ($brand->status == 1)
                                            <a href="{{ url('/brand_status' . $brand->id) }}" class="btn btn-success">
                                                <i class="halflings-icon white thumbs-down"></i>
                                            </a>
                                    </div>
                                @else
                                    <a href="{{ url('/brand_status' . $brand->id) }}" class="btn btn-danger">
            ...
            <div class="span2">
                <a href="{{ url('/brand/' . $brand->id . '/edit') }}" class="btn btn-info">
